...
def get_home_dir() -> Path:
    """Get the cli-bridge home directory."""
...
def get_channel_dir() -> Path:
    ...
    Directory structure:
        ~/.cli-bridge/workspace/channel/{channel_name}/{date}.json
    """
...
def sync_mcp_from_iflow(overwrite: bool = False) -> bool:
    """Sync MCP servers from iflow CLI settings to cli-bridge.
