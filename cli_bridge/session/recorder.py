...
from cli_bridge.utils import get_channel_dir
...
class ChannelRecorder:
    ...
    Directory structure:
        ~/.cli-bridge/workspace/channel/{channel_name}/{chat_id}-{date}.json
    ...
    def __init__(self, channel_dir: Path | None = None):
        """Initialize the recorder.
        
        Args:
            channel_dir: Custom channel directory path. Defaults to ~/.cli-bridge/workspace/channel
        """
    ...
    def _get_date_file(self, channel: str, chat_id: str, date: str | None = None) -> Path:
...
_recorder: ChannelRecorder | None = None
