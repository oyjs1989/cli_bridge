"""Session manager for cli-bridge.
...
class SessionManager:
    """Manages user sessions for cli-bridge.
    ...
    ~/.iflow/sessions/), while this module tracks cli-bridge specific
    session state.
    ...
    def delete_session(self, session_key: str) -> bool:
        ...
        Removes the session file. Note: This only removes the cli-bridge
