"""ConsoleService and module-level helpers/constants for the web console."""
...
from cli_bridge.config.loader import get_config_path
from cli_bridge.config.schema import Config
from cli_bridge.engine.adapter import IFlowAdapter
from cli_bridge.utils.helpers import get_channel_dir, get_home_dir
...
class ConsoleService:
    ...
    def _session_mapping_file(self) -> Path:
        return Path.home() / ".cli-bridge" / "session_mappings.json"
